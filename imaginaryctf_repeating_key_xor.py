...
file = base64.b64decode("""AAAAABIEAQMaECsSAQYrDQwaKwoGDwk= """)
print(file)
print()
...
# Test step 2
print("distance: 'this is a test' and 'wokka wokka!!!' =",
      distance([ord(c) for c in "this is a test"],
               [ord(c) for c in "wokka wokka!!!"]))  # 37 - Working
print()

hint = "AAAAABIEAQMaECsSAQYrDQwaKwoGDwk="
